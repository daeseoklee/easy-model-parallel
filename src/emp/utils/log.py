...
from emp import LOG_DIR, PROJECT_DIR, __version__, default_log_level
...
def setup_logging(
    ...
    Args:
        console_level: Logging level for console. Defaults to INFO or env var EMP_LOG_LEVEL.
